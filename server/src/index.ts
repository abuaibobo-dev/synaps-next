...
import cliToolsRouter from "./routes/cliTools.js";
...
app.use('/api/v1/kernel', capabilityKernelRouter);
app.use('/api/v1/proactive', proactiveRouter);
app.use('/api/v1/tasks', tasksRouter);
app.use('/api/v1/brains', brainsRouter);
app.use('/api/v1/bridge', bridgeRouter);
app.use('/api/v1/codex-local', codexLocalRouter);
app.use('/api/v1/cli-tools', cliToolsRouter);
